...
//}
//
//static int fsync_impl (const char * path __attribute__((unused)), int n __attribute__((unused)), struct fuse_file_info * fi __attribute__((unused))) {
//	return -EROFS;
//}
...
//		.fsyncdir = fsyncdir_impl, .releasedir = releasedir_impl, .fsync = fsync_impl
		};
